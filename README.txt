...
Here are the packages that are downloaded by autosnort (not including dependencies):
...
5. The name of the VRT rules tarball on the system (the script will NOT download the rules tarball for you)
...
Q: Why Ubuntu? Why not another distro?

A: I'm working on adding in support for other mainline distros as I get time to do so. I'm planning on a shell script to automate the install process on CentOS, Backtrack and Debian on 32 or 64 bit architectures.
