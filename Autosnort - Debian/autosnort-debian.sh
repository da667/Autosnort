...
# We're running uname -a and cutting out the arch field to determine if the user is running a 32 or 64 bit arch to determine which SO rules to copy.
...
case $boot_iface in
	1)
		...
		#the snort install guide recommends turning off checksum offloading for the sniffing interface.
