...
-Very stripped-down: This installer does NOT install pulledpork, barnyard2, or include any options to install an interface of any sort. This installs Snort, pulledpork, and persistence for both and that's it.
