...
while true; do
	...
	print_notification "6. no web interface or output method will be installed (Select this if you did not install apache or mysql and do NOT have an SIEM set up to report events to)"
